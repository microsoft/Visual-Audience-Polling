...
@SuppressLint("NewApi")
public class AttendanceWithoutRoster extends Activity implements
	...
	public static boolean attendancewr = false;
	...
	public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
		...
		//Mat resMat = filterIt(inputFrame.gray());
	...
	public void finishAttendance(View view) throws IOException{
	//	Toast.makeText(this, "The attendance results were automatically saved", Toast.LENGTH_LONG).show();
		saveNewRosterFile(getPresentIds(), getPollName());
		Intent i = new Intent(this,JumpInMain.class);
		i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		startActivity(i);
		//saveAttendanceResults(view);
	}
	...
	public String getPollName() throws IOException {
		...
		File fileDirectory = new File(Environment.getExternalStorageDirectory()
				+ "/QCards/AttendanceResults/WithoutRoster");
		File filePath = new File(Environment.getExternalStorageDirectory()
				+ "/QCards/AttendanceResults/WithoutRoster" + quizName + ".csv");
		...
		Toast.makeText(this, "The attendance results were automatically saved to "+fileDirectory.toString()+"/"+pollFileName, Toast.LENGTH_LONG).show();
	...
	public void saveAttendanceResults(View view) {
		saveAsNew(view, "Save Attendance Results");
	...
	public void saveAsNew(View v, String title){
		...
		fName.setHint("Enter a name for this session");
		sButton.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (!ifAttendanceFileExists(fName.getText().toString(), v)) {
					// saveModified();
					try {
						saveNewRosterFile(getPresentIds(),fName.getText().toString());
						dial.dismiss();
	...
	public void saveNewRosterFile(List<String> entries, String fileName)
			throws IOException {
